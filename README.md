...
**Point your local Ollama instance at `http://127.0.0.1:11434` and set `MODEL=ollama/qwen3:8b` in the `.env` file**

- Modify `src/latest_ai_flow/crews/content_crew/config/agents.yaml` to define your agents
- Modify `src/latest_ai_flow/crews/content_crew/config/tasks.yaml` to define your tasks
- Modify `src/latest_ai_flow/crews/content_crew/content_crew.py` to add your own logic, tools and specific args
